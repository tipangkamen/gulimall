...
import com.xiaozhu.gulimall.product.dao.AttrAttrgroupRelationDao;
import com.xiaozhu.gulimall.product.dao.AttrDao;
import com.xiaozhu.gulimall.product.dao.AttrGroupDao;
import com.xiaozhu.gulimall.product.dao.CategoryDao;
import com.xiaozhu.gulimall.product.entity.AttrAttrgroupRelationEntity;
    ...
    public PageUtils queryBaseAttrPage(Map<String, Object> params, Long catelogId,String attrType) {
        ...
        if (!StringUtils.isEmpty(key)) {
            queryWrapper.and(wrapper -> {
                wrapper.lambda().eq(AttrEntity::getAttrId, key).or().like(AttrEntity::getAttrName, key);
            });
        }
        IPage<AttrEntity> page = this.page(
                new Query<AttrEntity>().getPage(params),
